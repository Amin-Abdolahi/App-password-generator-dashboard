...
class RandomPasswordGenerator(PasswordGenerator):
    ...
    """
    def __init__(self, length: int = 8, include_numbers: bool = False, include_symbols: bool = False, include_uppercase: bool = False, include_lowercase: bool = False):
        self.length = length
...
class MemorablePasswordGenerator(PasswordGenerator):
    ...
    def __init__(
        ...
        self.vocabulary: List[str] = list(vocabulary if vocabulary is not None else [])
